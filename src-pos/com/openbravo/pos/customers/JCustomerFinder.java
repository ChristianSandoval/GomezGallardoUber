...
public class JCustomerFinder extends javax.swing.JDialog implements EditorCreator {
    ...
    public static JCustomerFinder getCustomerFinder(Component parent, DataLogicCustomers dlCustomers, String location) {
        ...
        myMsg.init(dlCustomers, location);
    ...
    private void init(DataLogicCustomers dlCustomers, String location) {
        ...
        lpr = new ListProviderCreator(dlCustomers.getCustomerList(location), this);
